...
class UserProfile(models.Model):
    ...
    desc = models.TextField('个人简介', max_length=500, blank=True, default='')
    gexing = models.CharField('个性签名', max_length=200, blank=True, default='')
...
class EmailVerifyRecord(models.Model):
    ...
    send_type = models.CharField(choices=SEND_TYPE_CHOICES, default=SEND_TYPE_CHOICES[0][0], max_length=20)
